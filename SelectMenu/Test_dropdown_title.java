...
public class Test_dropdown_title {
...
WebDriver driver;
	...
	public void FunctionMethod() {
		try {
			...
			Thread.sleep(2000);
			//Select Title
			WebElement select_Value = driver.findElement(By.id("selectOne"));
			select_Value.click();
			Thread.sleep(2000);
			List <WebElement> select_Value1 = driver.findElements(By.id("selectOne"));
			...
			for(int i=0;i<select_Value1.size();i++) {
				...
				if(select_Value1.get(i).getText().contains("Ms.")) {
