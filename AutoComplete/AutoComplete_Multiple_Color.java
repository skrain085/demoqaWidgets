...
public class AutoComplete_Multiple_Color {
...
WebDriver driver;
	...
	public void FunctionMethod() {
		try {
			...
			WebElement clickable = driver.findElement(By.xpath("//div[@id='autoCompleteMultipleContainer']"));
			clickable.click();
			Thread.sleep(2000);
			WebElement inputvalue = driver.findElement(By.xpath("//div[@id='autoCompleteMultipleContainer']/div/div/div/div"));
			Actions actions = new Actions(driver);
			actions.moveToElement(inputvalue).perform();
			//Sending red as an input
